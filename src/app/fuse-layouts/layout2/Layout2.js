  ...
  return (
    <AppContext.Consumer>
      {({ routes }) => (
        ...
        >
          {layoutConfig.leftSidePanel.display && <LeftSideLayout2 />}

          <div className="flex flex-1 flex-col overflow-hidden relative">
            {layoutConfig.toolbar.display &&
              layoutConfig.toolbar.position === "above" && <ToolbarLayout2 />}

            {layoutConfig.navbar.display && <NavbarWrapperLayout2 />}

            {layoutConfig.toolbar.display &&
              layoutConfig.toolbar.position === "below" && <ToolbarLayout2 />}
          ...
          {layoutConfig.rightSidePanel.display && <RightSideLayout2 />}
...
export default withStyles(styles, { withTheme: true })(
  withRouter(connect(mapStateToProps)(Layout2))
);
