...
export function getTodos(match) {
  const request = axios.get(Todo.GET, {
    params: match.params
  });
...
export function updateTodo(todo) {
  const request = axios.post(Todo.POST_UPDATE_TODO, todo);
...
export function addTodo(todo) {
  const request = axios.post(Todo.POST_NEW_TODO, todo);
...
export function removeTodo(todoId) {
  const request = axios.post(Todo.POST_REMOVE_TODO, todoId);
